...
my_address = '0x75e0Aa148B64b7BF1bBDb13D64197B3f213621f9'
...
tx2 = my_contract.functions.send_and_approve_WETH(10000000000000000).build_transaction({'nonce':nonce,'gas':3000000})
