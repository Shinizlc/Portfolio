...
class ICO_BOT:
    ...
    ##my wallet in goerli
    my_address_in_goeri = '0x9453A1E95F1e0c082752B513A7bFbE7383154a8a'
...
#######PROBLEM SHOULD BE SOMEWHERE HERE
    ...
    def swap_token(self,token_in,token_out,amount_to_buy):
        min_amount_to_buy = self.get_min_amount_to_buy(token_in, token_out, amount_to_buy)
        if min_amount_to_buy is not None and min_amount_to_buy!=0:
            nonce = ICO_BOT.w3.eth.get_transaction_count(ICO_BOT.my_address_in_goeri)
...
if __name__ == '__main__':
    #it works
    ico_bot1 = ICO_BOT()
    # ico_bot1.get_min_amount_to_buy('0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6','0xfDf686FB601A8dcC6865f02Ac4BfA8A2F14578f8',ICO_BOT.weth_buy_threshold)
