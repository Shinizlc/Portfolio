...
#####check approve for this token 0xC0Cadce2E6809d996959216bcCB1CF3C4c449e8e
    def add_approve_to_uniswap(self,amount,token):
        # try:
        nonce = ICO_BOT.w3.eth.get_transaction_count(ICO_BOT.my_address_in_goeri)
        logger.warning(f'approved amount :{amount}')
        ...
        while True:
            for PairCreated in event_filter.get_new_entries():
                try:
                    ...
                    logger.warning(f'token in:{token_in}, token out {token_out}, pair: {pair}')
                except:
...
##need to add some confitions for swaping token back to weth
    ...
    def swap_token(self, token_in, token_out, amount_to_buy):
        ...
        token_in_decimals = self.get_token_decimals(token_in)
        logger.warning(f'token in decimals:{token_in_decimals}')
        token_out_decimals = self.get_token_decimals(token_out)
        logger.warning(f'token out decimals:{token_out_decimals}')
        ...
        adjusted_amount_to_buy = int(Decimal(adjusted_amount_to_buy))
        logger.warning(f'adjusted amount to buy :{adjusted_amount_to_buy}')
        ...
        if min_amount_out is not None and min_amount_out != 0:
            ...
            tx = ICO_BOT.my_contract.functions._swap_token(token_in, token_out, adjusted_amount_to_buy, min_amount_out, ICO_BOT.my_contract_address).build_transaction({"nonce": nonce, "gas": ICO_BOT.gas})
...
#0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6
    def get_token_balance(self,token):
        ...
        adj_balance = balance * (10**(18-decimals))
        logger.warning(adj_balance)
...
###havn't checked, needed to get the correct token balance
    ...
    def trailing_implemetation(self):
      ...
      ###когда совершена покупка сразу же надо дурнуть get_pair_price(может pucharse_price получить из self.get_token.), set_take_profit,set_stop_loss. чтобы выставить
...
if __name__ == '__main__':
    ...
    # print(ico_bot1.get_min_amount_to_buy('0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6','0xfDf686FB601A8dcC6865f02Ac4BfA8A2F14578f8',ICO_BOT.weth_buy_threshold))
    # ico_bot1.get_min_amount_to_buy('0xfDf686FB601A8dcC6865f02Ac4BfA8A2F14578f8','0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6',ico_bot1.get_token_balance('0xfDf686FB601A8dcC6865f02Ac4BfA8A2F14578f8'))
    ...
    # ico_bot1 = ICO_BOT()
    # ico_bot1.get_min_amount_to_buy('0xE8905d43d4c545Dd8f693DECABF06B161D61ca5C','0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6',ico_bot1.get_token_balance('0xE8905d43d4c545Dd8f693DECABF06B161D61ca5C'))
    # ico_bot1.add_approve_to_uniswap(ICO_BOT.weth_allowance_threshold,ICO_BOT.weth_goerli)
...
##есть разница с тем что апрвувится и тем что свопается
# 64_545_103_002_758_238_640
#It should return about 59766997096441734 of token 0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6 for 64_545_103_002_758_242_304 of 0xfDf686FB601A8dcC6865f02Ac4BfA8A2F14578f8 token
#adjustments created some changes in value( even with equal decimals places)

#2133221692087552518052